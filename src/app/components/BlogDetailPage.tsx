  ...
  return (
    <div className="min-h-screen bg-[#FDF9F4] pt-24 pb-20 relative overflow-hidden">
      ...
      <article className="max-w-3xl mx-auto px-6 relative z-10">
        <button 
          onClick={() => navigate("/blog")}
          className="flex items-center gap-2 text-muted-foreground hover:text-[#5C3D24] transition-colors mb-8 group"
        >
        ...
        <header className="mb-12 text-center">
          ...
          <h1 className="text-3xl md:text-5xl font-serif text-[#5C3D24] leading-tight mb-6">
            {post.title}
          </h1>

          <div className="flex items-center justify-center gap-6 text-sm text-muted-foreground border-b border-[#E8C3BA]/20 pb-8">
        ...
        <div className="relative mb-12 rounded-2xl overflow-hidden shadow-xl shadow-[#D4AF37]/10 aspect-video">
          <img src={post.coverImage} alt={post.title} className="w-full h-full object-cover" />
        </div>

        <div 
          className="prose prose-lg prose-stone mx-auto prose-headings:font-serif prose-headings:text-[#5C3D24] prose-p:text-gray-600 prose-a:text-[#A0714A] prose-img:rounded-xl"
